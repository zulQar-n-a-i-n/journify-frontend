...
const Hero = () => {
  return (
    <section className="bg-gray-100 overflow-hidden relative">
      <Navbar />
      <div className="container mx-auto px-4 sm:px-8 lg:px-16 xl:px-20 2xl:px-24 grid grid-cols-1 md:grid-cols-2 min-h-[650px]">
        {/* Brand Info */}
        ...
        <div className="flex justify-center items-center">
          <motion.img
            ...
            src={HeroPng}
            alt=""
            className="w-[400px] xl:w-[600px] relative z-10 shadow-xl]"
          />
          <motion.img
            initial={{ x: -50, opacity: 0 }}
            animate={{ x: 0, opacity: 1 }}
