...
const ServicesData = [
  {
    id: 1,
    title: "Secure Diary",
    description: "Your thoughts are yours alone — stored privately and securely.",
    link: "#",
    icon: <GrSecure />,
    delay: 0.2,
  },
  
  {
    id: 3,
    title: "AI Insights",
    description: "Understand your mood through smart emotional analysis.",
    link: "#",
    icon: <RiComputerLine />,
    delay: 0.4,
  },
  {
    id: 4,
    title: "Mood Tracker",
    description: "Track your emotional trends with a simple dashboard.",
    link: "#",
    icon: <IoMdHappy />,
    delay: 0.5,
  },
  {
    ...
    description: "Generate reports to reflect on your mental journey.",
    link: "#",
    icon:  <MdSpeed />,
    delay: 0.6,
  },
  {
    id: 6,
    title: "Smart Tips",
    description: "Get personalized suggestions to feel better every day.",
    link: "#",
    icon: <BiSupport />,
    delay: 0.7,
  },
